...
//   doc.text(10, 65, "Test No: " + localStorage.getItem("rTestNo"));
  ...
  getreport = () => {
    axios.post('http://192.168.0.167:6002/Endurence.php' , { turboIdVal:this.state.turboIdVal , testno : this.state.testno1 } ,)    
      .then(res => {
  ...
  render() {
    ...
    var Turbine_Inlet = Math.round(this.state.reportOut.Turbine_Inlet * 100) / 100
        ...
        <div id="allreport">
            ...
            <img src = 'https://www.drdo.gov.in/sites/default/files/drdo_logo_0.png' />
                ...
                <table class="table table-striped table-sm export-table" id="example1">
                  <thead>
                    <tr>
                      <th style={{verticalAlign: 'middle', border: '1px solid #6a6a6b',  textAlign:'center'}} colspan="6">ENDURANCE TEST</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style={{verticalAlign: 'middle', border: '1px solid #6a6a6b',  textAlign:'center'}}>{RPM}</td>
                    ...
                    <tr ng-repeat="Rreport in RunningResult | filter:query  ">
                      <td style={{border: '1px solid #6a6a6b',textAlign:'center'}}>
                        ...
                        <td style={{border: '1px solid #6a6a6b', textAlign:'center'}}>{rpm}</td>
                        <td style={{border: '1px solid #6a6a6b', textAlign:'center'}}>{this.state.reportOut.Duration}</td>
                        <td style={{border: '1px solid #6a6a6b', textAlign:'center'}}></td>
                        <td style={{border: '1px solid #6a6a6b', textAlign:'center'}}></td>
                        <td style={{border: '1px solid #6a6a6b', textAlign:'center'}}>{Turbine_Inlet}</td>
                    </tr>
